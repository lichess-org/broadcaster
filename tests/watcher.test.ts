...
const events: {
  ...
  windows: {
    create: { type: { create: { kind: 'any' } }, paths: [String.raw`C:\path\to\new.txt`], attrs: {} },
    copyFileToFolder: { type: { create: { kind: 'any' } }, paths: [String.raw`C:\path\to\game-9.pgn`], attrs: {} },
    open: undefined,
    close: undefined,
    modify: { type: { modify: { kind: 'any' } }, paths: [String.raw`C:\path\to\games.pgn`], attrs: {} },
    delete: { type: { remove: { kind: 'any' } }, paths: [String.raw`C:\path\to\new.txt`], attrs: {} },
    rename: {
      type: { modify: { kind: 'rename', mode: 'both' } },
      paths: [String.raw`C:\path\to\old.pgn`, String.raw`C:\path\to\new.pgn`],
      attrs: {},
    },
  },
  macos: {
